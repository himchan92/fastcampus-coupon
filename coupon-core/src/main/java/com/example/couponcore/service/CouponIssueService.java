...
public class CouponIssueService {
    ...
    public void issue(long couponId, long userId) {
        Coupon coupon = findCoupon(couponId); //쿠폰정보 가져오기
        coupon.issue(); //발급, 기간 유효성 검증
        saveCouponIssue(couponId, userId); //어떤 사용자가 어떤 쿠폰발급받았는지 체크
    }
    ...
    public CouponIssue saveCouponIssue(long couponId, long userId) {
        checkAlreadyIssuance(couponId, userId); //이미 쿠폰발급되었는지 체크
